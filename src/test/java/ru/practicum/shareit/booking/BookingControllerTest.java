...
public class BookingControllerTest {
    ...
    void findAllByBookerAndState() throws Exception {
        when(service.findAllByBookerAndState(anyInt(), anyString(), anyInt(), anyInt())).thenReturn(List.of(bookingDto));
    ...
    void findAllByOwnerAndState() throws Exception {
        when(service.findAllByOwnerAndState(anyInt(), anyString(), anyInt(), anyInt())).thenReturn(List.of(bookingDto));
